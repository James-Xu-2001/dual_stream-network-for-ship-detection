...
def parse_model(d, ch, verbose=True, ir_start_idx=None):
    ...
    Args:
        ...
        ir_start_idx (int, optional): Index of IR stream first layer for dual-stream models.
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in base_modules:
            ...
            if ir_start_idx is not None and i == ir_start_idx:
                c1 = input_channels  # 使用原始输入通道 (3)
            else:
